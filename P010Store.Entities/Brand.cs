...
namespace P010Store.Entities
{
    public class Brand : IEntity
    {
        ...
        [StringLength(150)] // Resim adı için
        public string? Logo { get; set; } = ""; // property e varsayılan değer atama

        [Display(Name = "Durum")]
        public bool IsActive { get; set; }

        [Display(Name = "Eklenme Tarihi"), ScaffoldColumn(false)] // ScaffoldColumn(false) demek view ları oluşturulurken bu alanın ekranda oluşmasını engeller

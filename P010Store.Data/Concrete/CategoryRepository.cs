...
namespace P010Store.Data.Concrete
{
    public class CategoryRepository : Repository<Category>, ICategoryRepository
    {
        ...
        public async Task<Category> GetCategoryByProducts(int id)
        {
            ...
            //AsNoTracking context üzerindeki kategorilerden id si bu metoda gönderilen id ile eşleşen kaydı bul ve bu kaydı izleme (AsNoTracking), bulduğun kategorinin ürünlerini
            //de include ile join le birleştir ve ilk kaydı metodun çağrıldığı yere döndür.
        }
    }
}

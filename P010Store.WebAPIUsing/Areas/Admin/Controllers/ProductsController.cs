...
namespace P010Store.WebAPIUsing.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.CategoryId = new SelectList(await _httpClient.GetFromJsonAsync<List<Product>>(_apiAdres + "Categories"), "Id", "Name");
            ViewBag.BrandId = new SelectList(await _httpClient.GetFromJsonAsync<List<Product>>(_apiAdres + "Brands"), "Id", "Name");
            return View();
        }
        ...
        public async Task<ActionResult> Delete(int id, Product product)
        {
            try
            {
                var sonuc = await _httpClient.DeleteAsync(_apiAdres + "Products/" + id);

...
namespace P010Store.WebUI.Areas.Admin.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        [Route("/Admin/Logout")] // eğer uygulamada Admin/Logout url adresine istek gelirse, normalde adresi Admin/Login/Logout olan aşadağıdaki metodu çalıştır
        ...
        public async Task<IActionResult> Index(string email, string password)
        {
            try
            {
                ...
                if (kullanici is not null)
                {
                    ...
                    var kullaniciKimligi = new ClaimsIdentity(kullaniciHaklari, CookieAuthenticationDefaults.AuthenticationScheme /*"Login"*/);

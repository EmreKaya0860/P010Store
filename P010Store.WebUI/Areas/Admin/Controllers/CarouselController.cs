...
namespace P010Store.WebUI.Areas.Admin.Controllers
{
    ...
    {
        private readonly IService<Carousel> _service; // veritabanı işlemleri için generic olarak tasarladığımız repository sınıfını kullanan service interface ini brand class ı için
